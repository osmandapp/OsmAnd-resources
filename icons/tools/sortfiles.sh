...
mycp natural peak_night mm_functional-icons_peak_night.png  #For night orienteering use orange similar to contour lines (=day version with color #CC6600)  #scale 0.5
...
mycp sport scuba_diving mm_sport_scuba_diving.png  #derived from NPS public library
