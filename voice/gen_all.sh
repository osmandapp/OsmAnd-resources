...
./gen_voice.sh fi Finnish $ENGINE fi 1.3 yes
./gen_voice.sh fr French $ENGINE fr 1.3 yes
./gen_voice.sh hi Hindi $ENGINE hi 1.3 yes
./gen_voice.sh hu Hungarian $ENGINE hu 1.3 yes
./gen_voice.sh hu-formal Hungarian_formal $ENGINE hu-formal 1.3 yes
./gen_voice.sh it Italian $ENGINE it 1.3 yes
./gen_voice.sh ja Japanese $ENGINE ja 1.3 yes
./gen_voice.sh ko Korean $ENGINE ko 1.3 yes
./gen_voice.sh nl Dutch $ENGINE nl 1.3 yes
./gen_voice.sh pl Polish $ENGINE pl 1.3 yes
./gen_voice.sh pt Portuguese $ENGINE pt 1.3 yes
./gen_voice.sh pt-br Portuguese_BR $ENGINE pt-br 1.3 yes
./gen_voice.sh sv Swedish $ENGINE sv 1.3 yes
./gen_voice.sh zh Chinese $ENGINE zh 1.3 yes
./gen_voice.sh es-ar Spanish_AR $ENGINE es-ar 1.3 yes
./gen_voice.sh es Spanish $ENGINE es 1.3 yes
./gen_voice.sh en-gb English_GB $ENGINE en-gb 1.3 yes
./gen_voice.sh el Greek $ENGINE el 1.3 yes
./gen_voice.sh da Danish $ENGINE da 1.3 yes
./gen_voice.sh cs Czech $ENGINE cs 1.3 yes
./gen_voice.sh de German $ENGINE de 1.3 yes
./gen_voice.sh en English $ENGINE en 1.3 yes
./gen_voice.sh ru Russian $ENGINE ru 1.3 yes
