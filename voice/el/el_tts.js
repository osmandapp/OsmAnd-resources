...
function populateDictionary(tts) {
	...
	dictionary["left_sl"] = tts ? "στρίψτε λοξά αριστερά" : "left_sl.ogg";
	dictionary["right"] = tts ? "στρίψτε δεξιά" : "right.ogg";
	dictionary["right_sh"] = tts ? "στρίψτε κλειστά δεξιά" : "right_sh.ogg";
	dictionary["right_sl"] = tts ? "στρίψτε λοξά δεξιά" : "right_sl.ogg";
	...
	dictionary["left_keep"] = tts ? "μείνετε αριστερά" : "left_keep.ogg";
	dictionary["right_keep"] = tts ? "μείνετε δεξιά" : "right_keep.ogg";
	dictionary["left_bear"] = tts ? "μείνετε αριστερά" : "left_bear.ogg";  // in English the same as left_keep, may be different in other languages
	dictionary["right_bear"] = tts ? "μείνετε δεξιά" : "right_bear.ogg";    // in English the same as right_keep, may be different in other languages

	// U-TURNS
	dictionary["make_uturn"] = tts ? "κάντε αναστροφή" : "make_uturn.ogg";
	dictionary["make_uturn_wp"] = tts ? "Όταν είναι δυνατόν, κάντε αναστροφή" : "make_uturn_wp.ogg";
	...
	dictionary["enforcement_traffic_signals"] = tts ? "κάμερα κόκκινου σηματοδότη" : "enforcement_traffic_signals.ogg";
	...
	dictionary["tenths_of_a_mile"] = tts ? "δέκατα του μιλίου" : "tenths_of_a_mile.ogg";
	dictionary["around_1_mile"] = tts ? "περίπου ένα μίλι" : "around_1_mile.ogg";
	dictionary["miles"] = tts ? "μίλια" : "miles.ogg";
