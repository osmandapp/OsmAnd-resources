...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ROUTE CALCULATED
string('route_is.ogg', 'Turen er ').
string('route_calculate.ogg', 'Ruten beregnet på nytt').
string('distance.ogg', 'avstand ').

% LEFT/RIGHT
string('prepare.ogg', 'Forbered å ').
string('after.ogg', 'etter ').
string('in.ogg', 'i ').

string('left.ogg', 'ta til venstre').
string('left_sh.ogg', 'ta skarpt til venstre').
string('left_sl.ogg', 'ta litt til venstre').
string('right.ogg', 'ta til høyre').
string('right_sh.ogg', 'ta skarpt til høyre').
string('right_sl.ogg', 'ta litt til høyre').
string('left_keep.ogg', 'holde til venstre').
string('right_keep.ogg', 'holde til høyre').
string('left_bear.ogg', 'holde til venstre').   % in English the same as left_keep, may be different in other languages
string('right_bear.ogg', 'holde til høyre').    % in English the same as right_keep, may be different in other languages

% U-TURNS
string('make_uturn.ogg', 'Ta en U-sving').
string('make_uturn_wp.ogg', 'Ta en U-sving når det er mulig').

% ROUNDABOUTS
string('prepare_roundabout.ogg', 'kjør inn i en rundkjøring').
string('roundabout.ogg', 'kjør inn i rundkjøringen, ').
string('then.ogg', ' så ').
string('and.ogg', ' og ').
string('take.ogg', 'ta den ').
string('exit.ogg', 'avkjøringen').

string('1st.ogg', 'første ').
string('2nd.ogg', 'andre ').
string('3rd.ogg', 'tredje ').
string('4th.ogg', 'fjerde ').
string('5th.ogg', 'femte ').
string('6th.ogg', 'sjette ').
string('7th.ogg', 'syvende ').
string('8th.ogg', 'åttende ').
...
% STRAIGHT/FOLLOW
string('go_ahead.ogg', 'Fortsett rett fram').
string('follow.ogg', 'Følg veien ').

% ARRIVE
string('and_arrive_destination.ogg', 'og så ankommer du reisemålet ditt ').
string('reached_destination.ogg', 'du har nådd reisemålet ditt ').
string('and_arrive_intermediate.ogg', 'og så ankommer du det mellomliggende reisemålet ').
string('reached_intermediate.ogg', 'du har nådd det mellomliggende reisemålet ').

% NEARBY POINTS
string('and_arrive_waypoint.ogg', 'og passerer GPX-rutepunkt ').
string('reached_waypoint.ogg', 'du passerer GPX-rutepunkt ').
string('and_arrive_favorite.ogg', 'og passerer favoritt ').
string('reached_favorite.ogg', 'du passerer favoritt ').
string('and_arrive_poi.ogg', 'og passerer interessepunkt ').
string('reached_poi.ogg', 'du passerer interessepunkt ').

% ATTENTION
%string('exceed_limit.ogg', 'du overskrider fartsgrensen ').
string('exceed_limit.ogg', 'fartsgrense ').
string('attention.ogg', 'obs, ').
string('speed_camera.ogg', 'fotoboks').
string('border_control.ogg', 'grensekontroll').
string('railroad_crossing.ogg', 'jernbaneovergang').
string('traffic_calming.ogg', 'trafikkhump').
string('toll_booth.ogg', 'bomstasjon').
string('stop.ogg', 'stoppskilt').
string('pedestrian_crosswalk.ogg', 'fotgjengerovergang').
string('tunnel.ogg', 'tunnel').

% OTHER PROMPTS
string('location_lost.ogg', 'g p s signal mistet').
string('location_recovered.ogg', 'g p s signal gjenfunnet').
string('off_route.ogg', 'du har vært utenfor ruten for').
string('back_on_route.ogg', 'du er tilbake på ruten').
...
string('around_1_kilometer.ogg', 'omtrent 1 kilometer').
string('around.ogg', 'omtrent ').
string('kilometers.ogg', 'kilometer').

string('feet.ogg', 'fot ').
string('1_tenth_of_a_mile.ogg', 'en tiendedel av en engelsk mil').
string('tenths_of_a_mile.ogg', 'tiendedel av en engelsk mil').
string('around_1_mile.ogg', 'omtrent 1 engelsk mil').
string('miles.ogg', 'engelsk mil').
...
string('less_a_minute.ogg', 'mindre enn et minutt').
string('1_minute.ogg', 'ett minutt').
