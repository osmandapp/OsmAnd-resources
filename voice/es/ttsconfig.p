...
string('left_sh.ogg', 'gira pronunciadamente a la izquierda').
string('left_sl.ogg', 'gira levemente a la izquierda').
string('right.ogg', 'gira a la derecha').
string('right_sh.ogg', 'gira pronunciadamente a la derecha').
...
string('left_sh_inf.ogg', 'girar pronunciadamente a la izquierda').
string('left_sl_inf.ogg', 'girar levemente a la izquierda').
string('right_inf.ogg', 'girar a la derecha').
string('right_sh_inf.ogg', 'girar pronunciadamente a la derecha').
