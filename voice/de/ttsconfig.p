...
%%% distance measure
distance(Dist, nominativ) == [ X, 'meters_nominativ.ogg']                  :- Dist < 100,   D is round(Dist/10.0)*10,    num_atom(D, X).
distance(Dist, dativ) ==     [ X, 'meters_dativ.ogg']                      :- Dist < 100,   D is round(Dist/10.0)*10,    num_atom(D, X).
distance(Dist, nominativ) == [ X, 'meters_nominativ.ogg']                  :- Dist < 1000,  D is round(2*Dist/100.0)*50, num_atom(D, X).
distance(Dist, dativ) ==     [ X, 'meters_dativ.ogg']                      :- Dist < 1000,  D is round(2*Dist/100.0)*50, num_atom(D, X).
...
distance(Dist, nominativ) == ['around.ogg', X, 'kilometers_nominativ.ogg'] :- Dist < 10000, D is round(Dist/1000.0),     num_atom(D, X).
distance(Dist, dativ) ==     ['around.ogg', X, 'kilometers_dativ.ogg']     :- Dist < 10000, D is round(Dist/1000.0),     num_atom(D, X).
distance(Dist, nominativ) == [ X, 'kilometers_nominativ.ogg']              :-               D is round(Dist/1000.0),     num_atom(D, X).
distance(Dist, dativ) ==     [ X, 'kilometers_dativ.ogg']                  :-               D is round(Dist/1000.0),     num_atom(D, X).
