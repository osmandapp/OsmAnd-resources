...
function populateDictionary(tts) {
	...
	// U-TURNS
	dictionary["make_uturn"] = tts ? "Okrenite se natrag" : "make_uturn.ogg";
	dictionary["make_uturn_alt"] = tts ? "se okrenite natrag" : "make_uturn.ogg";
	dictionary["make_uturn_wp"] = tts ? "Kada bude moguće, okrenite se natrag" : "make_uturn_wp.ogg";
	...
	dictionary["take"] = tts ? "iziđite na" : "take.ogg";
	...
	// STRAIGHT/FOLLOW
	dictionary["go_ahead"] = tts ? "Idite ravno naprijed" : "go_ahead.ogg";
	...
	dictionary["reached_destination"] = tts ? "Stigli ste do svoga odredišta " : "reached_destination.ogg";
	...
	// NEARBY POINTS
	dictionary["and_arrive_waypoint"] = tts ? "i proći ćete ge pe iks međutočku " : "and_arrive_waypoint.ogg";
	dictionary["reached_waypoint"] = tts ? "prolazite ge pe iks međutočku " : "reached_waypoint.ogg";
	dictionary["and_arrive_favorite"] = tts ? "i proći ćete spremljenu točku " : "and_arrive_favorite.ogg";
	dictionary["reached_favorite"] = tts ? "prolazite spremljenu točku " : "reached_favorite.ogg";
	dictionary["and_arrive_poi"] = tts ? "i proći ćete točku interesa " : "and_arrive_poi.ogg";
	dictionary["reached_poi"] = tts ? "prolazite točku interesa " : "reached_poi.ogg";
	...
	dictionary["railroad_crossing"] = tts ? "željeznički prijelaz" : "railroad_crossing.ogg";
	dictionary["traffic_calming"] = tts ? "mjere smirenja prometa" : "traffic_calming.ogg";
	dictionary["toll_booth"] = tts ? "naplata cestarine" : "toll_booth.ogg";
	dictionary["stop"] = tts ? "znak stop" : "stop.ogg";
	dictionary["pedestrian_crosswalk"] = tts ? "pješački prijelaz" : "pedestrian_crosswalk.ogg";
	dictionary["tunnel"] = tts ? "tunel" : "tunnel.ogg";

	// OTHER PROMPTS
	dictionary["location_lost"] = tts ? "dži pi es signal je izgubljen" : "location_lost.ogg";
	dictionary["location_recovered"] = tts ? "dži pi es signal je ponovno pronađen" : "location_recovered.ogg";
	...
	dictionary["toward"] = tts ? "smjer" : "toward.ogg";
...
function route_recalc(dist, seconds) {
	return dictionary["route_calculate"] + ", " + dictionary["distance"] + " " + distance(dist, "nom") + ", " + dictionary["time"] + " " + time(seconds) + (tts ? ". " : "");
}
...
// roundabout(_Angle, Exit, Street) -- ["take", E, "exit" | Sgen] :- nth(Exit, E), turn_street(Street, Sgen).
	...
	return dictionary["in"] + " " + distance(dist, "acc") + " " + dictionary["roundabout"] + ", " + dictionary["and_alt"] + " " + dictionary["take"] + " " + nth(exit) + " " + dictionary["exit"] + " " + turn_street(streetName);
}
