...
function populateDictionary(tts) {
	...
	// LEFT/RIGHT
    //dictionary["prepare"] = tts ? "準備" : "prepare.ogg";
	...
	dictionary["follow"] = tts ? "沿著馬路往前 " : "follow.ogg";  // "Follow the course of the road for" perceived as too chatty by many users
	...
	// ATTENTION
    //dictionary["exceed_limit"] = tts ? "您超速了" : "exceed_limit.ogg";
	...
	dictionary["red_light_camera"] = tts ? "闖紅燈攝影機" : "red_light_camera.ogg";
	...
	dictionary["on"] = tts ? "到" : "on.ogg";    // is used if you turn together with your current street, i.e. street name does not change.
