...
distance_mi_m(Dist, locative) --   ['around.ogg', X, 'miles_locative.ogg']      :- Dist < 16093, D is round(Dist/1609.3),            dist(D, X).
distance_mi_m(Dist, accusative) -- [ X, 'miles_accusative.ogg']                 :-               D is round(Dist/1609.3),            dist(D, X).
distance_mi_m(Dist, locative) --   [ X, 'miles_locative.ogg']                   :-               D is round(Dist/1609.3),            dist(D, X).
