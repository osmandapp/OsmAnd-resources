...
% ROUNDABOUTS
string('prepare_roundabout.ogg', 'Prepare-se para entrar na rotatória').
...
% NEARBY POINTS
string('and_arrive_waypoint.ogg', 'e chegue ao ponto GPX ').
string('reached_waypoint.ogg', 'chegou ao ponto GPX ').
string('and_arrive_favorite.ogg', 'e chegue ao favorito ').
string('reached_favorite.ogg', 'chegou ao favorito ').
string('and_arrive_poi.ogg', 'e chegue ao POI ').
...
prepare_turn(Turn, Dist, Street) -- ['after.ogg', D, M | Sgen] :- distance(Dist) -- D, turn_imp(Turn, M), turn_street(Street, Sgen).
turn(Turn, Dist, Street) -- ['in.ogg', D, M | Sgen] :- distance(Dist) -- D, turn(Turn, M), turn_street(Street, Sgen).
turn(Turn, Street) -- [M | Sgen] :- turn(Turn, M), turn_street(Street, Sgen).

prepare_make_ut(Dist, Street) -- ['after.ogg', D, 'make_uturn_imp.ogg' | Sgen] :- distance(Dist) -- D, turn_street(Street, Sgen).
