...
% ARRIVE
string('and_arrive_destination.ogg', 'og du ankommer så til destinationen ').
string('reached_destination.ogg','du har nået destinationen ').
string('and_arrive_intermediate.ogg', 'og du ankommer så til viapunktet ').
string('reached_intermediate.ogg', 'du har nået viapunktet ').
string('and_arrive_waypoint.ogg', 'og du ankommer så til rutepunktet ').
string('reached_waypoint.ogg', 'du har nået rutepunktet ').
