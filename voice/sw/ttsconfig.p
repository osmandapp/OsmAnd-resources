...
string('on.ogg', 'kwenye ').
string('to.ogg', 'kwenye ').
string('toward.ogg', 'kuelekea ').
...
distance_mi_f(Dist) -- ['around.ogg', 'miles.ogg', X]    :- Dist < 16093, D is round(Dist/1609.3),            dist(D, X).
