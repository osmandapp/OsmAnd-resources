...
turn_street(Street, ['to.ogg', SName]) :- tts, not(Street = voice(["", "", D], _)), cut_part_street(Street, SName).
...
follow_street(Street, ['to.ogg', SName]) :- tts, not(Street = voice(["", "", D], _)), cut_part_street(Street, SName).
