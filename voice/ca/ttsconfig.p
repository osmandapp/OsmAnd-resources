...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ROUTE CALCULATED
string('route_is.ogg', 'La ruta té').
string('route_calculate.ogg', 'Ruta recalculada ').
string('distance.ogg', ', distància').

% LEFT/RIGHT
%string('prepare.ogg', 'Prepara`t per a').
string('after.ogg', 'després de ').
string('in.ogg', 'a ').

string('left.ogg', 'gira a l`esquerra').
string('left_sh.ogg', 'fes un gir tancat a l`esquerra').
string('left_sl.ogg', 'gira lleument a l`esquerra').
string('right.ogg', 'gira a la dreta').
string('right_sh.ogg', 'fes un gir tancat a la dreta').
string('right_sl.ogg', 'gira lleument a la derecha').
string('left_keep.ogg', 'estigues a l`esquerra').
string('right_keep.ogg', 'estigues a la dreta').
string('left_bear.ogg', 'estigues a l`esquerra').   % in English the same as left_keep, may be different in other languages
string('right_bear.ogg', 'estigues a la dreta').    % in English the same as right_keep, may be different in other languages

% U-TURNS
string('make_uturn.ogg', 'Dóna la volta').
string('make_uturn_wp.ogg', 'Quan puguis, fes la volta').

% ROUNDABOUTS
%string('prepare_roundabout.ogg', 'Prepara`t per entrar a la rotonda després de').
string('prepare_roundabout.ogg', 'entra a la rotonda ').
string('roundabout.ogg', 'entra a la rotonda').
string('then.ogg', ', llavors').
string('and.ogg', 'i').
string('take.ogg', 'agafa la').
string('exit.ogg', 'sortida').

string('1st.ogg', 'primera').
string('2nd.ogg', 'segona').
string('3rd.ogg', 'tercera').
string('4th.ogg', 'quarta').
string('5th.ogg', 'cinquena').
string('6th.ogg', 'sisena').
string('7th.ogg', 'setena').
string('8th.ogg', 'vuitena').
string('9th.ogg', 'novena').
string('10th.ogg', 'desena').
string('11th.ogg', 'onzena').
string('12th.ogg', 'dotzena').
string('13th.ogg', 'tretzena').
string('14th.ogg', 'catorzena').
string('15th.ogg', 'quinzena').
string('16th.ogg', 'setzena').
string('17th.ogg', 'dissetena').

% STRAIGHT/FOLLOW
string('go_ahead.ogg', 'Continua recte').
string('follow.ogg', 'Segueix la via durant').

% ARRIVE
string('and_arrive_destination.ogg', 'i arribaràs a la teva destinació').
string('reached_destination.ogg','has arribat a la teva destinació').
string('and_arrive_intermediate.ogg', 'i arribaràs al teu punt intermig').
string('reached_intermediate.ogg', 'has arribat al teu punt intermig').

% NEARBY POINTS
string('and_arrive_waypoint.ogg', 'i passaràs el teu punt G P X intermig').
string('reached_waypoint.ogg', 'estàs passant el teu punt intermig G P X').
string('and_arrive_favorite.ogg', 'i passaràs el teu favorit ').
string('reached_favorite.ogg', 'estàs passant el teu punt favorit ').
string('and_arrive_poi.ogg', 'i passaràs el P D I ').
string('reached_poi.ogg', 'estàs passant el P D I ').

% ATTENTION
%string('exceed_limit.ogg', 'estàs excedint el límit de velocitat ').
string('exceed_limit.ogg', 'límit de velocitat ').
string('attention.ogg', 'atenció, ').
string('speed_camera.ogg', 'radar de velocitat ').
string('border_control.ogg', 'control fronterer ').
string('railroad_crossing.ogg', 'pas a nivell ').
string('traffic_calming.ogg', 'ressalt').
string('toll_booth.ogg', 'guixeta de peatge ').
string('stop.ogg', 'senyal d`ESTOP ').
string('pedestrian_crosswalk.ogg', 'pas de vianants ').

% OTHER PROMPTS
string('location_lost.ogg', 'senyal g p s perduda').
string('location_recovered.ogg', 'senyal g p s trobada ').
string('off_route.ogg', 't`has desviat de la ruta').
string('back_on_route.ogg', 'has tornat a la ruta').

% STREET NAME PREPOSITIONS
string('onto.ogg', 'en direcció a ').
string('on.ogg', 'en ').
string('to.ogg', 'cap a ').
string('toward.ogg', 'cap a ').

% DISTANCE UNIT SUPPORT
string('meters.ogg', 'metres').
string('around_1_kilometer.ogg', 'aproximadament un quilòmetre').
string('around.ogg', 'aproximadament').
string('kilometers.ogg', 'quilòmetres').

string('feet.ogg', 'peus').
string('1_tenth_of_a_mile.ogg', 'una dècima de milla').
string('tenths_of_a_mile.ogg', 'dècimes de milla').
string('around_1_mile.ogg', 'aproximadament una milla').
string('miles.ogg', 'milles').

string('yards.ogg', 'iardes').

% TIME SUPPORT
string('time.ogg', 'temps necessari ').
string('1_hour.ogg', 'una hora ').
string('hours.ogg', 'hores ').
string('less_a_minute.ogg', 'menys d`un minut ').
string('1_minute.ogg', 'un minut ').
string('minutes.ogg', 'minuts ').

% SPECIAL NUMBERS
string('20_and.ogg', 'vint-i-').
